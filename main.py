...
def home():
    if request.method == 'POST':
        ...
        # ✅ Predict disease
        # In real app, you'd extract severity info from form
        # For now, assume all symptoms are 'severe' => score 1.0
    ...
    my_diet=rec_diet,
    workout=workout,
    symptoms=list(symptoms_dict.keys()),  # for autocomplete
    rec_data_count=rec_data_count,
    top_predictions=top_predictions  # 🔥 add this!
)
